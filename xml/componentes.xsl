    ...
    <xsl:template name="menu">
        <nav class="menu">
            <ul class="menu_lista">
                ...
                <li class="menu_item">
                    <a class="menu_link" href="productos_tabla_1.html">Productos tabla 1</a>
                </li>
                <li class="menu_item">
                    <a class="menu_link" href="productos_tabla_2.html">Productos tabla 2</a>
                </li>
                <li class="menu_item">
                    <a class="menu_link" href="productos_ficha_1.html">Productos ficha 1</a>
                </li>
                <li class="menu_item">
                    <a class="menu_link" href="productos_ficha_2.html">Productos ficha 2</a>
                </li>
                <li class="menu_item">
